...
const translations = {
    ...
    admin: {
        ...
        activeSubscriptions: { en: 'Active Subscriptions', zh: '活跃订阅' },
        userList: { en: 'User List', zh: '用户列表' },
        subscriptionList: { en: 'Subscription List', zh: '订阅列表' },
        name: { en: 'Name', zh: '姓名' },
        email: { en: 'Email', zh: '电子邮箱' },
        role: { en: 'Role', zh: '角色' },
        subscription: { en: 'Subscription', zh: '订阅计划' },
        expiry: { en: 'Expiry Date', zh: '到期日期' },
        status: { en: 'Status', zh: '状态' },
    ...
    home: {
        badge: { en: '🌟 Latest Question Bank Sept-Dec 2025', zh: '🌟 2025年9-12月最新题库' },
        title1: { en: 'Master IELTS', zh: 'Master IELTS' },
        title2: { en: 'Speaking', zh: 'Speaking' },
        subtitle: { en: 'Complete Framework + Vocabulary + Sample Answers for Band 8.0+', zh: '完整答题框架 + 高分词汇 + 参考答案，助你冲刺8.0+' },
        btnStart: { en: 'Start Learning', zh: '开始学习' },
        btnPractice: { en: 'Practice Center', zh: '练习中心' },
        card1Title: { en: 'Complete Framework', zh: '完整框架' },
        card1Desc: { en: 'Standardized Answer Structure', zh: '标准化答题结构' },
        card2Title: { en: 'High-Score Vocabulary', zh: '高分词汇' },
        card2Desc: { en: 'Authentic Expressions', zh: '地道表达积累' },
        card3Title: { en: 'Target Score', zh: '目标分数' },
        feature1Title: { en: 'Complete Question Bank', zh: '完整题库' },
        feature1Desc: { en: 'Sept-Dec 2025 Real Questions', zh: '2025年9-12月真题' },
        feature2Title: { en: 'Expert Tips', zh: '高分技巧' },
        feature2Desc: { en: 'Four Assessment Criteria', zh: '四大评分标准' },
        feature3Title: { en: 'Mock Practice', zh: '模拟练习' },
        feature3Desc: { en: 'Framework + Vocabulary + Answers', zh: '框架+词汇+答案' }
    },
    practice: {
        title: { en: 'Practice Center', zh: '练习中心 Practice Center' },
        subtitle: { en: 'Framework + Vocabulary + Sample Answers = Complete Preparation', zh: '框架 + 词汇 + 范例答案 = 完整备考方案' },
        regularTopics: { en: 'Regular Basic Topics', zh: '常规基础话题' },
        hotTopics: { en: 'Quarterly Hot Topics', zh: '季度热门考题' },
        part1Title: { en: 'Part 1: Interview Questions', zh: 'Part 1: Interview Questions' },
        part1Desc: { en: 'Daily topics Q&A (4-5 minutes)', zh: '日常话题简短问答 (4-5分钟)' },
        part23Title: { en: 'Part 2 & 3: Cue Card + Discussion', zh: 'Part 2 & 3: Cue Card + Discussion' },
        part23Desc: { en: 'Long turn + Follow-up (6-8 minutes)', zh: '话题卡陈述 + 深入讨论 (6-8分钟)' },
        backBtn: { en: '← Back to Practice Center', zh: '← 返回练习中心' },
        framework: { en: 'Answer Framework', zh: '答题框架 Answer Framework' },
        vocabulary: { en: 'Key Vocabulary', zh: '高分词汇 Key Vocabulary' },
        sampleAnswer: { en: 'Sample Answer', zh: '参考答案 Sample Answer' },
        expertTips: { en: 'Expert Tips', zh: '专家点评 Expert Tips' },
        part2Label: { en: 'Part 2: Cue Card', zh: 'Part 2: Cue Card 话题卡' },
        part3Label: { en: 'Part 3: Follow-up Discussion', zh: 'Part 3: Follow-up Discussion 深入讨论' },
        part3Desc: { en: 'Extended questions based on Part 2 topic', zh: '基于Part 2话题的延伸问题' }
    },
    topics: {
        title: { en: 'Speaking Topics', zh: 'Speaking Topics' },
        subtitle: { en: 'Complete Question Bank Sept-Dec 2025', zh: '2025年9-12月完整题库' }
    },
    tips: {
        title: { en: 'Four Assessment Criteria', zh: 'Four Assessment Criteria' },
        subtitle: { en: 'IELTS Speaking Assessment Standards', zh: 'IELTS口语四大评分标准' }
    },
    difficulty: {
        easy: { en: 'Easy', zh: '简单' },
...
function switchLanguage(lang) {
    ...
    document.getElementById('lang-en').className = lang === 'en'
        ? 'px-4 py-2 rounded-xl font-medium text-xs transition-all bg-white text-primary-700 shadow-sm'
        : 'px-4 py-2 rounded-xl font-medium text-xs transition-all text-slate-600 hover:bg-white/80';
    ...
    document.querySelectorAll('.nav-link').forEach(btn => {
        ...
        btn.textContent = translations.nav[key][lang];
    });
...
const db = {
    topics: {
        part1: [
            {
                ...
                topics: [
                    { title: 'Clothes', questions: ['Do you like buying clothes?', 'What kind of clothes do you never wear?', 'What type of clothes do you usually wear?'] },
                    { title: 'Keys', questions: ['Do you always bring a lot of keys with you?', 'Have you ever lost your keys?', 'Do you think it\'s a good idea to leave your keys with a neighbor?'] },
                    { title: 'Chocolate', questions: ['Do you like eating chocolate? Why?', 'Did you often eat chocolate when you were a kid?', 'Why do you think chocolate is popular around the world?'] },
                    { title: 'Small Business', questions: ['Are there many small businesses where you live?', 'Do you prefer buying things from small or big companies?', 'Have you ever thought about starting your own business?'] },
                    { title: 'Concentration', questions: ['Is it difficult for you to stay focused?', 'What do you do to improve concentration?', 'What may distract you when you are trying to stay focused?'] },
                    { title: 'Outdoor Activities', questions: ['Do you like outdoor activities?', 'What outdoor activities do you like to do?', 'How often do you do outdoor activities?'] },
                    { title: 'Memory', questions: ['Why do some people have good memory while others just don\'t?', 'What do you remember to do every day?', 'Have you ever forgotten something important?'] },
                    { title: 'Coins', questions: ['Do you use coins in your daily life?', 'Did you collect coins when you were younger?', 'Is it convenient to use coins?'] }
                ]
            },
            {
                category: '📚 必考话题',
                topics: [
                    ...
                    { title: 'The Area You Live In', questions: ['Do you like the area that you live in?', 'What are some changes in the area recently?', 'Do you know any famous people in your area?'] }
                ]
            },
            {
                category: '⚡ 高频保留题',
                topics: [
                    { title: 'Music', questions: ['What kind of music do you like?', 'Have you ever been to a concert?', 'Do you think music can change people\'s moods?'] },
                    { title: 'Weather', questions: ['What\'s the weather like where you live?', 'Do you prefer hot or cold weather?', 'Does the weather affect your mood?'] },
                    { title: 'Birthday', questions: ['What do you usually do on your birthday?', 'What did you do on your last birthday?', 'Which birthday was the most special for you?'] },
                    { title: 'Social Media', questions: ['Do you use social media?', 'What do people do on social media?', 'What are the disadvantages of social media?'] },
                    { title: 'Weekends', questions: ['What do you usually do on weekends?', 'Did you do anything special last weekend?', 'What will you do next weekend?'] },
                    { title: 'Friends', questions: ['Do you have many friends?', 'How often do you meet your friends?', 'What do you and your friends usually do together?'] }
                ]
            }
        ],
        part2: [
                ...
                topics: [
                    {
                        ...
                        cueCard: 'Describe a friend who is good at music\n描述一位擅长音乐的朋友\n\nYou should say:\n• Who this friend is 这位朋友是谁\n• What kind of music they are good at 他/她擅长什么类型的音乐\n• How you know about their musical talent 你如何知道他/她的音乐才能\n• And explain why you think they are good at music 解释为什么你认为他/她擅长音乐'
                    },
                    {
                        title: '重要的好朋友 Important Friend',
                        cueCard: 'Describe an important friend in your life\n描述你生命中一位重要的朋友\n\nYou should say:\n• Who this friend is 这位朋友是谁\n• How you met this friend 你如何认识这位朋友\n• What you do together 你们一起做什么\n• And explain why this friend is important to you 解释为什么这位朋友对你很重要'
                    },
                    {
                        title: '家族企业工作者 Family Business Worker',
                        cueCard: 'Describe a person who works in a family business\n描述一位在家族企业工作的人\n\nYou should say:\n• Who this person is 这个人是谁\n• What the family business is 家族企业是做什么的\n• What role this person plays 这个人扮演什么角色\n• And explain how you feel about working in a family business 解释你对在家族企业工作的看法'
                    },
                    {
                        title: '钦佩的有创造力的人 Creative Person',
                        cueCard: 'Describe a creative person you admire\n描述一位你钦佩的有创造力的人\n\nYou should say:\n• Who he/she is 他/她是谁\n• How you knew him/her 你如何认识他/她\n• What creative work they do 他/她做什么创造性工作\n• And explain why you think he/she is creative 解释为什么你认为他/她有创造力'
                    },
                    {
                        title: '钦佩的运动员 Sports Person',
                        cueCard: 'Describe a successful sports person you admire\n描述一位你钦佩的成功运动员\n\nYou should say:\n• Who he/she is 他/她是谁\n• What sport they play 他/她从事什么运动\n• What achievements they have made 他/她取得了什么成就\n• And explain why you admire him/her 解释为什么你钦佩他/她'
                    }
                ]
            },
            {
                ...
                topics: [
                    {
                        title: '新开的商店 New Shop',
                        cueCard: 'Describe a new store/shop that recently opened\n描述一家最近新开的商店\n\nYou should say:\n• Where the shop is 商店在哪里\n• What it sells 它卖什么\n• Who goes to this shop 谁会去这家商店\n• And explain how you feel about this shop 解释你对这家商店的感受'
                    },
                    {
                        title: '有趣的建筑 Interesting Building',
                        cueCard: 'Describe an interesting building you have visited\n描述一座你参观过的有趣建筑\n\nYou should say:\n• Where it is 它在哪里\n• What it looks like 它看起来怎么样\n• When you visited it 你什么时候参观的\n• And explain why you think it is interesting 解释为什么你认为它有趣'
                    },
                    {
                        title: '自然之地 Natural Place',
                        cueCard: 'Describe a natural place (e.g. parks, mountains)\n描述一个自然之地（如公园、山脉）\n\nYou should say:\n• Where this place is 这个地方在哪里\n• How you knew this place 你如何知道这个地方\n• What it is like 它是什么样的\n• And explain why you like to visit it 解释为什么你喜欢去那里'
                    }
                ]
            },
            {
                category: '⚡ 事件/经历类 Events & Experiences',
                topics: [
                    {
                        title: '手机的重要用途 Important Mobile Phone Use',
                        cueCard: 'Describe a time when you used your mobile phone to do something important\n描述一次你用手机做重要事情的经历\n\nYou should say:\n• When it happened 什么时候发生的\n• What happened 发生了什么\n• How important the mobile phone was 手机有多重要\n• And explain how you felt about it 解释你的感受'
                    },
                    {
                        title: '帮助儿童 Helping a Child',
                        cueCard: 'Describe a time when you helped a child\n描述一次你帮助儿童的经历\n\nYou should say:\n• When it was 什么时候\n• Who you helped 你帮助了谁\n• How you helped him/her 你如何帮助他/她\n• And explain how you felt about it 解释你的感受'
                    },
                    {
                        title: '迷路经历 Lost Your Way',
                        cueCard: 'Describe a time when you lost your way\n描述一次你迷路的经历\n\nYou should say:\n• When and where it happened 什么时候在哪里发生的\n• How you felt when you were lost 迷路时你的感受\n• How you found your way 你如何找到路\n• And explain how you felt about the experience 解释你对这次经历的感受'
                    },
                    {
                        title: '想再去的旅行 Trip to Make Again',
                        cueCard: 'Describe a trip you would like to make again\n描述一次你想再去一次的旅行\n\nYou should say:\n• Where you went 你去了哪里\n• When you went there 你什么时候去的\n• What you did there 你在那里做了什么\n• And explain why you would like to go there again 解释为什么你想再去一次'
                    },
                    {
                        title: '远途旅行 Long Journey',
                        cueCard: 'Describe a long journey you had\n描述一次你的长途旅行\n\nYou should say:\n• Where you went 你去了哪里\n• Who you had the journey with 你和谁一起旅行\n• Why you had the journey 你为什么进行这次旅行\n• And explain how you felt about the journey 解释你对这次旅行的感受'
                    },
                    {
                        title: '别人向你道歉 Someone Apologized',
                        cueCard: 'Describe a time when someone apologized to you\n描述一次别人向你道歉的经历\n\nYou should say:\n• When it was 什么时候\n• Who this person is 这个人是谁\n• Why he or she apologized to you 他/她为什么向你道歉\n• And how you felt about it 你的感受如何'
                    },
                    {
                        title: '第一次尝试的兴奋活动 Exciting Activity',
                        cueCard: 'Describe an exciting activity you have tried for the first time\n描述一次你第一次尝试的令人兴奋的活动\n\nYou should say:\n• What it is 是什么活动\n• When/where you did it 你什么时候/在哪里做的\n• Why you thought it was exciting 为什么你认为它令人兴奋\n• And explain how you felt about it 解释你的感受'
                    },
                    {
                        title: '初次用外语沟通 First Foreign Language Talk',
                        cueCard: 'Describe the time when you first talked with others in a foreign language\n描述你第一次用外语与他人交谈的经历\n\nYou should say:\n• Where you were 你在哪里\n• Who you were with 你和谁在一起\n• What you talked about 你们谈论了什么\n• And explain how you felt about it 解释你的感受'
                    },
                    {
                        title: '住所停电 Power Outage',
                        cueCard: 'Describe a time when the electricity suddenly went off at where you live\n描述一次你住所突然停电的经历\n\nYou should say:\n• When it happened 什么时候发生的\n• How long it lasted 持续了多久\n• What you did during that time 那段时间你做了什么\n• And explain how you felt about it 解释你的感受'
                    },
                    {
                        title: '和亲友的晚餐 Great Dinner',
                        cueCard: 'Describe a great dinner you and your friend or family members enjoyed\n描述一次你和朋友或家人享受的美好晚餐\n\nYou should say:\n• What you had 你们吃了什么\n• Who you had the dinner with 你和谁一起吃饭\n• What you talked about during the dinner 晚餐时你们谈论了什么\n• And explain why you enjoyed it 解释为什么你喜欢它'
                    },
                    {
                        title: '弄坏东西 Broke Something',
                        cueCard: 'Describe a time when you broke something\n描述一次你弄坏东西的经历\n\nYou should say:\n• What it was 是什么东西\n• When/where that happened 什么时候/在哪里发生的\n• How you broke it 你如何弄坏的\n• And explain what you did after that 解释之后你做了什么'
                    },
                    {
                        title: '等待特别事情 Waited for Something Special',
                        cueCard: 'Describe a time when you waited for something special that would happen\n描述一次你等待特别事情发生的经历\n\nYou should say:\n• What you waited for 你等待什么\n• Where you waited 你在哪里等待\n• Why it was special 为什么它特别\n• And explain how you felt while you were waiting 解释等待时你的感受'
                    },
                    {
                        title: '别人帮助下做的决定 Important Decision',
                        cueCard: 'Describe an important decision made with the help of other people\n描述一个在别人帮助下做出的重要决定\n\nYou should say:\n• What the decision was 决定是什么\n• Why you made the decision 你为什么做这个决定\n• Who helped you make the decision 谁帮助你做决定\n• And how you felt about it 你的感受如何'
                    }
                ]
            },
            {
                category: '🎯 物品/兴趣类 Objects & Interests',
                topics: [
                    {
                        title: '想了解的野生动物 A Wild Animal',
                        cueCard: 'Describe a wild animal you would like to learn more about\n描述一种你想了解更多的野生动物\n\nYou should say:\n• What the animal is 是什么动物\n• Where it lives 它生活在哪里\n• What it looks like 它看起来怎么样\n• And explain why you want to learn more about it 解释为什么你想了解更多'
                    },
                    {
                        title: '感兴趣的科学领域 Science Subject',
                        cueCard: 'Describe a science subject you are interested in\n描述一个你感兴趣的科学领域\n\nYou should say:\n• What it is 是什么科学领域\n• How you learned about it 你如何了解它\n• Why you are interested in it 你为什么对它感兴趣\n• And explain how you think it will help you in the future 解释你认为它将如何帮助你'
                    },
                    {
                        title: '传统故事 Traditional Story',
                        cueCard: 'Describe a traditional story from your country\n描述一个来自你国家的传统故事\n\nYou should say:\n• What the story is about 故事讲的是什么\n• How you learned about it 你如何了解它\n• Who usually tells this story 通常谁讲这个故事\n• And explain why this story is important 解释为什么这个故事重要'
                    },
                    {
                        title: '想提升的天赋 Natural Talent',
                        cueCard: 'Describe a natural talent you want to improve\n描述一个你想提升的天赋\n\nYou should say:\n• What it is 是什么天赋\n• When you discovered this talent 你什么时候发现这个天赋\n• How you want to improve it 你想如何提升它\n• And explain why you want to improve it 解释为什么你想提升它'
                    },
                    {
                        title: '童年玩具 Childhood Toy',
                        cueCard: 'Describe a toy you enjoyed playing with in your childhood\n描述一个你童年时喜欢玩的玩具\n\nYou should say:\n• What the toy was 是什么玩具\n• Who gave it to you 谁给你的\n• How you played with it 你如何玩它\n• And explain why you enjoyed playing with it 解释为什么你喜欢玩它'
                    },
                    {
                        title: '家中老物件 Old Thing',
                        cueCard: 'Describe an important old thing that your family has kept for a long time\n描述你家保存很久的重要老物件\n\nYou should say:\n• What it is 是什么东西\n• How/when your family first got this thing 你家如何/何时得到它\n• How long your family has kept it 你家保存了多久\n• And explain why this thing is important to your family 解释为什么它对你家重要'
                    },
                    {
                        title: '社交媒体趣事 Social Media',
                        cueCard: 'Describe a time you saw something interesting on social media\n描述一次你在社交媒体上看到有趣内容的经历\n\nYou should say:\n• When it was 什么时候\n• Where you saw it 你在哪里看到的\n• What you saw 你看到了什么\n• And explain why you think it was interesting 解释为什么你认为它有趣'
                    },
                    {
                        title: '有用的书 Useful Book',
                        cueCard: 'Describe a book you read that you found useful\n描述一本你读过的有用的书\n\nYou should say:\n• What it is 是什么书\n• When you read it 你什么时候读的\n• Why you think it is useful 你为什么认为它有用\n• And explain how you felt about it 解释你的感受'
                    },
                    {
                        title: '朋友的好习惯 Friend\'s Habit',
                        cueCard: 'Describe a good habit your friend has\n描述你朋友的一个好习惯\n\nYou should say:\n• Who your friend is 你的朋友是谁\n• What the habit is 是什么习惯\n• How you know about this habit 你如何知道这个习惯\n• And explain why you think it is a good habit 解释为什么你认为这是个好习惯'
                    },
                    {
                        title: '优质服务 Good Service',
                        cueCard: 'Describe a time you received good service\n描述一次你接受优质服务的经历\n\nYou should say:\n• Where you received the service 你在哪里接受服务\n• What service you received 你接受了什么服务\n• Who provided the service 谁提供的服务\n• And explain why you think it was good service 解释为什么你认为这是优质服务'
                    }
                ]
            }
        ],
        part3: [
            {
                category: '👨‍👩‍👧 人物与关系 People & Relationships',
                topics: [
                    { title: 'Music & Talent 音乐与才能', questions: ['Why do some people have musical talent?', 'Should children learn to play musical instruments?', 'How do artists acquire inspiration?'] },
                    { title: 'Friendship 友谊', questions: ['What qualities make a good friend?', 'How do people maintain long-distance friendships?', 'Is it easier to make friends now than in the past?'] },
                    { title: 'Family Business 家族企业', questions: ['What are the advantages of working in a family business?', 'Why do some family businesses fail?', 'Should children be expected to work in the family business?'] },
                    { title: 'Creativity 创造力', questions: ['Do you think creativity is important in the workplace?', 'What jobs require creativity?', 'Can creativity be learned or is it innate?'] },
                    { title: 'Sports 体育', questions: ['Should students have physical education and do sports at school?', 'What qualities should an athlete have?', 'Why are there so few top athletes?'] }
                ]
            },
            {
                category: '📍 地点与环境 Places & Environment',
                topics: [
                    { title: 'Shopping & Consumerism 购物与消费', questions: ['Why do some people prefer shopping online?', 'What are the advantages of shopping in physical stores?', 'How has shopping changed in recent years?'] },
                    { title: 'Architecture 建筑', questions: ['What makes a building interesting?', 'Should old buildings be preserved?', 'How do modern buildings differ from traditional ones?'] },
                    { title: 'Natural Places 自然之地', questions: ['What kind of people like to visit natural places?', 'What are the differences between a natural place and a city?', 'What can people gain from going to natural places?'] }
                ]
            },
            {
                category: '⚡ 经历与事件 Experiences & Events',
                topics: [
                    { title: 'Technology & Mobile Phones 科技与手机', questions: ['How has mobile technology changed our lives?', 'Do people rely too much on mobile phones?', 'What are the disadvantages of using mobile phones too much?'] },
                    { title: 'Helping Children 帮助儿童', questions: ['Why is it important to help children?', 'What can parents do to teach children to help others?', 'Should students do volunteer work?'] },
                    { title: 'Travel & Journeys 旅行', questions: ['Do you think it is a good choice to travel by plane?', 'What are the differences between group travelling and travelling alone?', 'Why do some people like making long journeys?'] },
                    { title: 'Apologies 道歉', questions: ['Do you think people should apologize for anything wrong they do?', 'On what occasion do people usually apologize to others?', 'Why do some people refuse to say "sorry" to others?'] },
                    { title: 'New Experiences 新体验', questions: ['Why are some people unwilling to try new things?', 'Why are some people keen on doing dangerous activities?', 'What are the benefits of trying new things?'] },
                    { title: 'Language Learning 语言学习', questions: ['At what age should children start learning a foreign language?', 'Which skill is more important, speaking or writing?', 'Do you think minority languages will disappear?'] },
                    { title: 'Electricity & Power 电力', questions: ['Which is better, electric bicycles or ordinary bicycles?', 'Which is better, electric cars or petrol cars?', 'Do people use more electricity now than before?'] },
                    { title: 'Food & Dining 食物与用餐', questions: ['Why do people like to have meals together during important festivals?', 'What do people often talk about during meals?', 'Is it a hassle to prepare a meal at home?'] },
                    { title: 'Fixing Things 修理物品', questions: ['What kind of things are more likely to be broken by people at home?', 'What kind of people like to fix things by themselves?', 'Do you think elderly people should teach young people how to fix things?'] },
                    { title: 'Waiting & Patience 等待与耐心', questions: ['On what occasions do people usually need to wait?', 'Who behave better when waiting, children or adults?', 'Compared to the past, are people less patient now, why?'] },
                    { title: 'Decision Making 决策', questions: ['What kind of decisions do you think are meaningful?', 'Why are some people unwilling to make quick decisions?', 'Why do people like to ask others for advice?'] }
                ]
            },
            {
                category: '🎯 兴趣与物品 Interests & Objects',
                topics: [
                    { title: 'Wildlife & Animals 野生动物', questions: ['Why is it important to protect wild animals?', 'What can individuals do to protect wildlife?', 'Should zoos exist?'] },
                    { title: 'Science & Education 科学与教育', questions: ['Why is science education important?', 'Should all students study science?', 'How has technology changed education?'] },
                    { title: 'Traditional Culture 传统文化', questions: ['Why is it important to preserve traditional stories?', 'How can traditional culture be passed down to younger generations?', 'Do young people today care about traditional culture?'] },
                    { title: 'Talents & Skills 才能与技能', questions: ['Are people born with talents or can they be developed?', 'What is more important, talent or hard work?', 'How can parents help children develop their talents?'] },
                    { title: 'Childhood & Toys 童年与玩具', questions: ['What kind of toys do children like nowadays?', 'Do you think children have too many toys today?', 'What can children learn from playing with toys?'] },
                    { title: 'Old Things & Heritage 老物件与传承', questions: ['What kind of old things do people like to keep?', 'Why do people keep old things?', 'What can we learn from a museum?'] },
                    { title: 'Social Media 社交媒体', questions: ['Why do people like to use social media?', 'What kinds of things are popular on social media?', 'What are the advantages and disadvantages of using social media?'] },
                    { title: 'Reading & Books 阅读与书籍', questions: ['What are the types of books that young people like to read?', 'What\'s the difference between paper books and e-books?', 'Do you think it is easier for children who start reading from a young age to succeed?'] },
                    { title: 'Habits 习惯', questions: ['What are some good habits people should develop?', 'How can people develop good habits?', 'Why do some people find it difficult to change bad habits?'] },
                    { title: 'Customer Service 客户服务', questions: ['What makes good customer service?', 'Why is customer service important for businesses?', 'How has customer service changed with technology?'] }
                ]
            }
        ]
    },
        ...
        part1: [
            {
                ...
                question: 'Do you like eating chocolate? Why?\n你喜欢吃巧克力吗？为什么？',
                sampleAnswer: `Yes, I'm absolutely a chocolate lover! I find chocolate to be an instant mood booster, especially dark chocolate. Whenever I feel stressed or tired, having a small piece of quality chocolate can really lift my spirits.
...
5. "rich and complex flavor" – High-quality dark chocolate has a rich and complex flavor profile.
   （高品质黑巧克力有着浓郁而复杂的风味特征。）`,
                tips: [
                    'Use enthusiastic language: "absolutely", "instant mood booster" 使用热情的语言',
                    'Be specific about preferences (dark vs milk) 具体说明偏好（黑巧克力vs牛奶巧克力）',
                    'Show awareness of health aspects 展示对健康方面的认识',
                    'Mention specific percentages or brands for authenticity 提及具体百分比或品牌以增加真实性'
                ]
            },
            {
                id: 102,
                type: 'hot',
                topic: 'Small Business 小企业',
                difficulty: 'Easy',
                difficultyColor: 'bg-green-100 text-green-700',
                question: 'Do you prefer buying things from small or big companies?\n你更喜欢从小公司还是大公司购买东西？',
                sampleAnswer: `I generally prefer supporting small businesses when possible. There's something special about the personal service and unique products that local shops offer. The owners are often passionate about what they do, and you can feel that dedication in the quality.
...
5. "everyday necessities" – For everyday necessities, I shop at larger stores for better prices.
   （对于日常必需品，我在大型商店购物以获得更好的价格。）`,
                tips: [
                    'Show balanced thinking 展示平衡思维',
                    'Give reasons for both sides 为双方提供理由',
                    'Use "strike a balance" to show maturity 使用"取得平衡"展示成熟度',
                    'Mention specific scenarios for each choice 为每种选择提及具体场景'
                ]
            },
            {
                id: 103,
                type: 'regular',
                topic: 'Concentration 专注力',
                difficulty: 'Medium',
                difficultyColor: 'bg-blue-100 text-blue-700',
                question: 'What do you do to improve concentration?\n你会做什么来提高专注力？',
                sampleAnswer: `I've developed several strategies to maintain focus. First, I eliminate distractions by putting my phone on silent mode and closing unnecessary browser tabs. I find that even small interruptions can break my concentration.
...
5. "significantly affect" – Sleep quality significantly affects my ability to concentrate.
   （睡眠质量显著影响我的专注能力。）`,
                tips: [
                    'Mention specific techniques (Pomodoro) 提及具体技巧（番茄工作法）',
                    'Structure answer: "First... Secondly..." 结构化回答："首先...其次..."',
                    'Connect lifestyle factors (sleep, exercise) 关联生活方式因素（睡眠、运动）',
                    'Show awareness of what breaks concentration 展示对破坏专注力因素的认识'
                ]
            }
        ],
        part23: [
            {
                ...
                part2: {
                    ...
                    sampleAnswer: `I'd like to talk about my close friend, David, who is an incredibly talented guitarist and singer. I met him during my first year at university when we were both assigned to the same dormitory, and we've been good friends ever since.
...
5. "pursue music seriously" – I encouraged him to pursue music seriously as a career.
   （我鼓励他认真地把音乐作为职业追求。）`,
                    tips: [
                        'Describe the person\'s musical abilities specifically 具体描述此人的音乐才能',
                        'Mention the genre/style they excel at 提及他们擅长的流派/风格',
                        'Explain your emotional response to their music 解释你对他们音乐的情感反应',
                        'Include specific examples or occasions 包含具体例子或场合'
                    ]
                },
                part3: {
                    questions: [
            ...
            },
            {
                id: 202,
                type: 'hot',
                topic: '手机的重要用途 Technology & Mobile Phones',
                difficulty: 'Medium',
                difficultyColor: 'bg-purple-100 text-purple-700',
                part2: {
                    question: 'Describe a time when you used your mobile phone to do something important\nYou should say:\n• When it happened\n• What happened\n• How important the mobile phone was\n• And explain how you felt about it\n\n描述一次你用手机做重要事情的经历\n你应该说：\n• 什么时候发生的\n• 发生了什么\n• 手机有多重要\n• 并解释你对此的感受',
                    sampleAnswer: `I'd like to describe an incident that happened last summer when my mobile phone literally saved the day. I was hiking in a mountainous area about two hours from the city with a group of friends when one of them, Mike, twisted his ankle quite badly on a steep trail.
...
5. "more than just entertainment tools" – Smartphones are more than just entertainment tools; they're productivity devices.
   （智能手机不仅仅是娱乐工具；它们是生产力设备。）`,
            ...
            },
            {
                id: 203,
                type: 'regular',
                topic: '帮助儿童 Helping Children',
                difficulty: 'Medium',
                difficultyColor: 'bg-pink-100 text-pink-700',
                part2: {
                    question: 'Describe a time when you helped a child\nYou should say:\n• When it was\n• Who you helped\n• How you helped him/her\n• And explain how you felt about it\n\n描述一次你帮助孩子的经历\n你应该说：\n• 什么时候\n• 你帮助了谁\n• 你如何帮助他/她\n• 并解释你对此的感受',
                    sampleAnswer: `I'd like to share an experience from last year when I helped my neighbor's daughter, Emma, who's 10 years old, prepare for a school science project. Her parents both work long hours, and she was struggling with a project about renewable energy that seemed quite advanced for her age.
...
5. "absolutely worthwhile" – The effort was absolutely worthwhile when I saw the positive results.
   （当我看到积极的结果时，这些努力绝对值得。）`,
                    tips: [
                        'Describe the child and situation clearly 清楚描述孩子和情况',
                        'Explain your specific approach 解释你的具体方法',
                        'Show the process, not just the outcome 展示过程，而不仅仅是结果',
                        'Reflect on what you learned 反思你学到了什么'
                    ]
                },
                part3: {
                    questions: [
                        {
                            q: 'Why is it important to help children?\n为什么帮助儿童很重要？',
                            a: 'Helping children is crucial because they\'re in their formative years, and the support they receive now shapes who they become as adults. Firstly, children\'s brains are incredibly plastic and receptive to learning, so positive interventions can have long-lasting effects. When we help a child overcome a challenge, we\'re not just solving that immediate problem – we\'re teaching them problem-solving strategies they\'ll use throughout life. Secondly, the emotional support we provide builds their self-esteem and resilience. A child who feels supported is more likely to develop the confidence to take on future challenges. Additionally, in today\'s complex world, children face pressures and situations that previous generations didn\'t encounter, like cyberbullying or information overload. They need guidance from adults who can help them navigate these challenges. Finally, from a societal perspective, investing time in helping children is investing in the future. Today\'s supported children become tomorrow\'s capable, contributing adults.\n\n帮助儿童至关重要，因为他们正处于成长期，他们现在得到的支持塑造了他们成年后的样子。首先，儿童的大脑具有极强的可塑性和学习接受能力，因此积极的干预可以产生持久的影响。当我们帮助孩子克服挑战时，我们不仅仅是解决眼前的问题——我们是在教他们终生使用的解决问题的策略。其次，我们提供的情感支持建立了他们的自尊和韧性。感到被支持的孩子更有可能发展出应对未来挑战的信心。此外，在当今复杂的世界中，儿童面临着前几代人没有遇到的压力和情况，如网络欺凌或信息过载。他们需要成年人的指导来帮助他们应对这些挑战。最后，从社会角度来看，投入时间帮助儿童就是投资未来。今天得到支持的儿童会成为明天有能力、有贡献的成年人。'
                        },
                        {
                            q: 'What can parents do to teach children to help others?\n父母可以做什么来教孩子帮助他人？',
            ...
            },
            {
                id: 204,
                type: 'hot',
                topic: '新开的商店 Shopping & Consumerism',
                difficulty: 'Hard',
                difficultyColor: 'bg-rose-100 text-rose-700',
                part2: {
                    question: 'Describe a new store/shop that recently opened\nYou should say:\n• Where the shop is\n• What it sells\n• Who goes to this shop\n• And explain how you feel about this shop\n\n描述一家最近开业的新商店\n你应该说：\n• 商店在哪里\n• 它卖什么\n• 谁去这家商店\n• 并解释你对这家商店的感受',
                    sampleAnswer: `I'd like to talk about a fascinating bookstore that opened in my neighborhood about three months ago called "Chapter & Brew." It's not just your typical bookstore – it's a hybrid space that combines a curated bookshop with a specialty coffee shop, creating a unique community gathering spot.
   ...
   （艺术画廊丰富了城市的文化生活。）`,
            ...
            },
            {
                ...
                part2: {
                    ...
                    sampleAnswer: `I'd like to talk about the snow leopard, a magnificent wild animal that has fascinated me ever since I saw a documentary about it on National Geographic about two years ago. Although I've never seen one in person, the images and footage from that documentary left a lasting impression on me.
...
5. "cultural significance" – Tigers hold great cultural significance in many Asian countries.
   （老虎在许多亚洲国家具有重要的文化意义。）`,
                    tips: [
                        'Describe the animal vividly 生动地描述动物',
                        'Explain your curiosity 解释你的好奇心',
                        'Show genuine interest 展示真正的兴趣',
                        'Mention specific aspects you want to learn 提及你想学习的具体方面'
                    ]
                },
                part3: {
                    questions: [
            ...
            },
            {
                id: 206,
                type: 'hot',
                topic: '感兴趣的科学领域 Science Subject',
                difficulty: 'Hard',
                difficultyColor: 'bg-purple-100 text-purple-700',
                part2: {
...
5. "provide a strong foundation" – Mathematics provides a strong foundation for engineering studies.
   （数学为工程学研究提供了坚实的基础。）`,
                    tips: [
                        'Be specific about the science field 具体说明科学领域',
                        'Explain how you learned about it 解释你如何了解到它',
                        'Show passion and curiosity 展示热情和好奇心',
                        'Connect it to real-world applications 将其与实际应用联系起来'
                    ]
                },
                part3: {
                    questions: [
            ...
            },
            {
                id: 207,
                type: 'regular',
                topic: '朋友的好习惯 Friend\'s Habit',
                difficulty: 'Medium',
                difficultyColor: 'bg-blue-100 text-blue-700',
                part2: {
                    question: 'Describe a habit your friend has and you want to develop\nYou should say:\n• Who your friend is\n• What habit he/she has\n• When you noticed this habit\n• And explain why you want to develop this habit\n\n描述你朋友的一个你想养成的好习惯\n你应该说：\n• 你的朋友是谁\n• 他/她有什么习惯\n• 你什么时候注意到这个习惯\n• 并解释你为什么想养成这个习惯',
                    sampleAnswer: `I'd like to talk about my close friend Sarah and her admirable habit of journaling every evening before bed. Sarah and I have been friends since university, and we often share an apartment, which is how I became aware of this consistent practice of hers.
...
5. "on autopilot" – I was living on autopilot until I started setting intentional goals.
   （在我开始设定有意识的目标之前，我一直在自动驾驶模式下生活。）`,
                    tips: [
                        'Describe the habit clearly 清楚地描述习惯',
                        'Explain the benefits 解释好处',
                        'Show motivation to improve 展示改进的动力',
                        'Include specific examples of how the habit helps 包含习惯如何帮助的具体例子'
                    ]
                },
                part3: {
                    questions: [
            ...
            },
            {
                id: 208,
                type: 'hot',
                topic: '传统故事 Traditional Story',
                difficulty: 'Medium',
                difficultyColor: 'bg-amber-100 text-amber-700',
                part2: {
                    question: 'Describe an interesting traditional story\nYou should say:\n• What the story is about\n• When/how you knew it\n• Who told you the story\n• And explain how you felt when you first heard it\n\n描述一个有趣的传统故事\n你应该说：\n• 故事是关于什么的\n• 你何时/如何知道它的\n• 谁告诉你这个故事\n• 并解释你第一次听到它时的感受',
                    sampleAnswer: `I'd like to share a traditional Chinese story called "The Butterfly Lovers" or "Liang Shanbo and Zhu Yingtai," which is often described as China's Romeo and Juliet. I first heard this story from my grandmother when I was about eight years old, during a summer vacation at her house in the countryside.
...
5. "fight for what you believe in" – It's important to fight for what you believe in, even when it's difficult.
   （为你所信仰的东西而战很重要，即使很困难。）`,
                    tips: [
                        'Narrate the story engagingly 引人入胜地讲述故事',
                        'Explain cultural significance 解释文化意义',
                        'Share personal feelings 分享个人感受',
                        'Include key plot points but keep it concise 包含关键情节但保持简洁'
                    ]
                },
                part3: {
                    questions: [
   ...
   （现代建筑越来越多地融入太阳能板等可持续特征。）`,
            ...
            },
            {
                ...
                part2: {
                    ...
                    sampleAnswer: `I'd like to talk about my best friend, Lisa, who has been an incredibly important person in my life for over a decade now. She's someone I can always count on, no matter what situation I'm facing.
...
5. "bring joy into life" – Pets bring joy into many people's lives.
   （宠物给许多人的生活带来欢乐。）`,
            ...
            },
            {
                id: 211,
                type: 'regular',
                topic: '迷路经历 Lost Your Way',
                difficulty: 'Medium',
                difficultyColor: 'bg-orange-100 text-orange-700',
                part2: {
                    question: 'Describe an occasion when you lost your way\nYou should say:\n• Where you were\n• What happened\n• How you felt\n• And explain how you found your way\n\n描述一次你迷路的经历\n你应该说：\n• 你在哪里\n• 发生了什么\n• 你感觉如何\n• 并解释你如何找到路',
                    sampleAnswer: `I'd like to share an experience from last year when I got completely lost while traveling in Kyoto, Japan. It was both frustrating and, looking back now, somewhat amusing.
...
3. "find one's way" – I finally found my way back.
   （我终于找到了回去的路。）`,
                    tips: [
                        'Describe the situation clearly 清楚地描述情况',
                        'Express emotions 表达情绪',
                        'Explain the solution 解释解决方法',
                        'Reflect on lessons learned 反思学到的教训'
                    ]
                },
                part3: {
                    questions: [
            ...
            },
            {
                id: 212,
                type: 'hot',
                topic: '想再去的旅行 Trip to Make Again',
                difficulty: 'Easy',
                difficultyColor: 'bg-teal-100 text-teal-700',
                part2: {
                    question: 'Describe a trip you would like to make again\nYou should say:\n• Where and when you went\n• Who you made the trip with\n• What you did during the trip\n• And explain why you would like to make the trip again\n\n描述一次你想再去的旅行\n你应该说：\n• 你何时去了哪里\n• 你和谁一起旅行\n• 你在旅行中做了什么\n• 并解释你为什么想再去一次',
                    sampleAnswer: `I'd love to talk about a trip I took to Guilin in southern China two years ago. It was during the summer vacation, and I went with three of my university classmates. This trip left such a wonderful impression on me that I've been wanting to go back ever since.
...
5. "create new memories" – Repeating the trip would create new memories.
   （重游会创造新的回忆。）`,
                    tips: [
                        ...
                        'Mention both positive experiences and any regrets 提及积极体验和任何遗憾'
                    ]
                },
                part3: {
                    questions: [
            ...
            },
            {
                id: 213,
                type: 'regular',
                topic: '想提升的天赋 Natural Talent',
                difficulty: 'Medium',
                difficultyColor: 'bg-cyan-100 text-cyan-700',
                part2: {
                    question: 'Describe a natural talent you would like to improve\nYou should say:\n• What it is\n• When you discovered it\n• How you want to improve it\n• And how you feel about it\n\n描述一个你想提升的天赋\n你应该说：\n• 它是什么\n• 你何时发现它\n• 你想如何提升它\n• 以及你对此的感受',
                    sampleAnswer: `I'd like to talk about my natural talent for drawing, which I've had since childhood but haven't developed as much as I'd like. I discovered this talent when I was about seven years old in primary school art class. While other students struggled with basic sketches, I found I could easily capture proportions and create realistic drawings. My teacher noticed this and often displayed my work, which boosted my confidence.
...
【常用表达 Useful Phrases & Examples】\n1. "constant companion" – My teddy bear was my constant companion during childhood.\n   （我的泰迪熊是我童年时期的固定伙伴。）\n\n2. "provide comfort" – Soft toys provide comfort when children feel scared.\n   （当孩子们感到害怕时，软玩具提供安慰。）\n\n3. "bring back memories" – Looking at old photos brings back happy memories.\n   （看老照片带回快乐回忆。）\n\n4. "emotional security" – Children need emotional security from their parents.\n   （孩子们需要从父母那里获得情感安全感。）\n\n5. "pass down" – This toy was passed down from my older sister.\n   （这个玩具是我姐姐传下来的。）\n\n6. "create stories" – Children often create stories with their toys.\n   （孩子们经常用玩具创造故事。）`,
            ...
            },
            {
                id: 215,
                type: 'regular',
                topic: '家族企业工作者 Family Business Worker',
                difficulty: 'Medium',
                difficultyColor: 'bg-lime-100 text-lime-700',
                part2: {
                    question: 'Describe a person you know who enjoys working for a family business\nYou should say:\n• Who he/she is\n• What the business is\n• What his/her job is\n• And explain why he/she enjoys working there\n\n描述一个你认识的在家族企业工作并乐在其中的人',
                    sampleAnswer: `I'd like to talk about my friend's father, Mr. Chen, who runs and works in his family's restaurant business. He's in his mid-50s and has been working in this restaurant for over 30 years, which was originally started by his parents.
...
5. "build something for the future" – They're building something for future generations to inherit.
   （他们在为未来几代人建设可继承的事业。）`,
            ...
            },
            {
                id: 216,
                type: 'hot',
                topic: '优质服务 Good Service',
                difficulty: 'Medium',
                difficultyColor: 'bg-emerald-100 text-emerald-700',
                part2: {
                    question: 'Describe a time when you received good service from a staff member in a shop\nYou should say:\n• Where the shop is\n• When you went to the shop\n• What service you received from the staff\n• And explain how you felt about the service\n\n描述一次你在商店从员工那里获得优质服务的经历',
                    sampleAnswer: `I'd like to share an experience from last month at a local electronics store. I went there to buy a laptop for university, which was a significant purchase for me, and I received exceptional service from a staff member named Kevin.\n\n我想分享上个月在当地一家电子产品商店的经历。我去那里为大学买笔记本电脑，这对我来说是一笔重要的购买，我从一位名叫Kevin的员工那里获得了卓越的服务。
...
6. "respond promptly" – The company responds promptly to all customer inquiries.
   （公司迅速回应所有客户询问。）`,
            ...
            },
            {
                id: 217,
                type: 'regular',
                topic: '住所停电 Power Outage',
                difficulty: 'Easy',
                difficultyColor: 'bg-slate-100 text-slate-700',
                part2: {
                    question: 'Describe a time when the electricity suddenly went off at where you live\nYou should say:\n• When it happened\n• How long it lasted\n• What you did during that time\n• And explain how you felt about it\n\n描述一次你住所突然停电的经历',
                    sampleAnswer: `Last summer, during a particularly hot evening in July, the electricity suddenly went off in my apartment building. It happened around 8 PM when I was studying for exams. The power outage lasted for about three hours, which felt much longer in the summer heat.
...
5. "bring people together" – Difficult times can bring people together in unexpected ways.
   （困难时期能以意想不到的方式把人们聚在一起。）`,
            ...
            },
            {
                id: 218,
                type: 'hot',
                topic: '和亲友的晚餐 Great Dinner',
                difficulty: 'Easy',
                difficultyColor: 'bg-red-100 text-red-700',
                part2: {
                    question: 'Describe a great dinner you and your friend or family members enjoyed\nYou should say:\n• What you had\n• Who you had the dinner with\n• What you talked about during the dinner\n• And explain why you enjoyed it\n\n描述一次你和朋友或家人享受的美好晚餐',
                    sampleAnswer: `I'd like to talk about a wonderful dinner I had with my family last Chinese New Year. It was at my grandparents' house, and all my extended family gathered – about 15 people including aunts, uncles, and cousins.\n\n我想谈谈去年春节我和家人共进的一顿美好晚餐。那是在我祖父母家，所有大家庭成员都聚集了——大约15人，包括阿姨、叔叔和表兄弟姐妹。
...
6. "create lasting memories" – Such family dinners help create lasting memories.
   （这样的家庭聚餐有助于创造持久的回忆。）`,
            ...
            },
            {
                id: 219,
                type: 'regular',
                topic: '远途旅行 Long Journey',
                difficulty: 'Medium',
                difficultyColor: 'bg-violet-100 text-violet-700',
                part2: {
                    question: 'Describe a long journey you had\nYou should say:\n• Where you went\n• Who you had the journey with\n• Why you had the journey\n• And explain how you felt about the journey\n\n描述一次你的长途旅行',
                    sampleAnswer: `I'd like to talk about a long train journey I took from Beijing to Lhasa, Tibet two years ago. The journey covered over 3,700 kilometers and took about 40 hours. I traveled with my college roommate during our summer vacation.
...
5. "transform from...to..." – The landscape transformed from desert to lush forest as we traveled north.
   （当我们向北旅行时，风景从沙漠变成了茂密的森林。）`,
            ...
            },
            {
                id: 220,
                type: 'hot',
                topic: '别人向你道歉 Someone Apologized',
                difficulty: 'Medium',
                difficultyColor: 'bg-fuchsia-100 text-fuchsia-700',
                part2: {
                    question: 'Describe a time when someone apologized to you\nYou should say:\n• When it was\n• Who this person is\n• Why he or she apologized to you\n• And how you felt about it\n\n描述一次别人向你道歉的经历',
                    sampleAnswer: `I'd like to share an experience from last year when my close friend apologized to me after a misunderstanding. We had planned to meet for an important event – my birthday celebration – but she didn't show up and didn't respond to my messages.\n\n我想分享去年的一次经历，当时我的好朋友在一次误会后向我道歉。我们计划见面参加一个重要活动——我的生日庆祝——但她没有出现，也没有回复我的消息。
...
6. "accept an apology" – I accepted her apology and we moved forward.
   （我接受了她的道歉，我们继续前进。）`,
            ...
            },
            {
                id: 221,
                type: 'regular',
                topic: '第一次尝试的兴奋活动 Exciting Activity',
                difficulty: 'Medium',
                difficultyColor: 'bg-sky-100 text-sky-700',
                part2: {
                    question: 'Describe an exciting activity you have tried for the first time\nYou should say:\n• What it is\n• When/where you did it\n• Why you thought it was exciting\n• And explain how you felt about it\n\n描述一次你第一次尝试的令人兴奋的活动',
                    sampleAnswer: `I'd like to talk about my first time skydiving, which I did last year during a trip to New Zealand. It was something I'd always wanted to try but never had the courage until my friends convinced me.
...
5. "incredibly rewarding" – Volunteering can be incredibly rewarding and fulfilling.
   （志愿服务可以非常有益和充实。）`,
            ...
            },
            {
                id: 222,
                type: 'regular',
                topic: '初次用外语沟通 First Foreign Language Talk',
                difficulty: 'Medium',
                difficultyColor: 'bg-rose-100 text-rose-700',
                part2: {
                    question: 'Describe the time when you first talked with others in a foreign language\nYou should say:\n• Where you were\n• Who you were with\n• What you talked about\n• And explain how you felt about it\n\n描述你第一次用外语与他人交谈的经历',
                    sampleAnswer: `I remember my first real conversation in English happened when I was 15, during a summer camp that hosted international students. I was paired with an American student named Jake for a group project.
   ...
   （我感到复杂的情绪——紧张但也兴奋。）`,
            ...
            },
            {
                ...
                part2: {
                    ...
                    sampleAnswer: `I'd like to talk about an antique pocket watch that has been in my family for over 80 years. It's a beautiful gold-plated watch with intricate engravings on the cover.
...
5. "symbolize the passage of time" – The old tree symbolizes the passage of time.
   （这棵老树象征着时间的流逝。）`,
            ...
            },
            {
                id: 224,
                type: 'regular',
                topic: '钦佩的有创造力的人 Creative Person',
                difficulty: 'Hard',
                difficultyColor: 'bg-purple-100 text-purple-700',
                part2: {
                    ...
                    sampleAnswer: `I'd like to talk about Hayao Miyazaki, the renowned Japanese animator and filmmaker. I first discovered his work when I watched "Spirited Away" as a child, and I've been fascinated by his creativity ever since.
...
5. "transform into magical narratives" – A true creative person can transform everyday experiences into magical narratives.
   （一个真正有创造力的人能将日常经历转化为神奇的叙事。）`,
            ...
            },
            {
                id: 225,
                type: 'hot',
                topic: '社交媒体趣事 Social Media',
                difficulty: 'Easy',
                difficultyColor: 'bg-blue-100 text-blue-700',
                part2: {
                    question: 'Describe a time you saw something interesting on social media\nYou should say:\n• When it was\n• Where you saw it\n• What you saw\n• And explain why you think it was interesting\n\n描述一次你在社交媒体上看到有趣内容的经历',
                    sampleAnswer: `Recently, about two months ago, I came across a fascinating video on Instagram that really caught my attention. It was a short documentary-style post about a young engineer who built a prosthetic hand using 3D printing technology for children in developing countries.
...
5. "solve real-world problems" – Engineering is about using science to solve real-world problems.
   （工程学是关于利用科学解决现实世界的问题。）`,
            ...
            },
            {
                id: 226,
                type: 'regular',
                topic: '弄坏东西 Broke Something',
                difficulty: 'Easy',
                difficultyColor: 'bg-orange-100 text-orange-700',
                part2: {
                    question: 'Describe a time when you broke something\nYou should say:\n• What it was\n• When/where that happened\n• How you broke it\n• And explain what you did after that\n\n描述一次你弄坏东西的经历',
                    sampleAnswer: `I'd like to talk about a time last year when I accidentally broke my mother's favorite ceramic vase. It happened at home in our living room on a Saturday afternoon.\n\n我想谈谈去年我不小心打碎了我母亲最喜欢的陶瓷花瓶的经历。那是在周六下午我们家客厅发生的。
   ...
   （修理费有点贵，但很值得。）`,
                ...
                part3: {
                    questions: [
                        ...
                        {
                            q: 'Do you think elderly people should teach young people how to fix things?\n你认为老年人应该教年轻人如何修东西吗？',
            ...
            },
            {
                id: 227,
                type: 'hot',
                topic: '钦佩的运动员 Sports Person',
                difficulty: 'Medium',
                difficultyColor: 'bg-green-100 text-green-700',
                part2: {
                    question: 'Describe a successful sports person you admire\nYou should say:\n• Who he/she is\n• What you know about him/her\n• What he/she is like in real life\n• What achievement he/she has made\n• And explain why you admire him/her\n\n描述一位你钦佩的成功运动员',
                    sampleAnswer: `I'd like to talk about Yao Ming, the legendary Chinese basketball player. He's one of the most successful Asian athletes in NBA history and someone I've admired since childhood.
...
5. "grace in handling fame" – He shows remarkable grace in handling his fame.
   （他在处理名声方面表现出非凡的优雅。）`,
            ...
            },
            {
                id: 228,
                type: 'regular',
                topic: '有用的书 Useful Book',
                difficulty: 'Medium',
                difficultyColor: 'bg-indigo-100 text-indigo-700',
                part2: {
                    question: 'Describe a book you read that you found useful\nYou should say:\n• What it is\n• When you read it\n• Why you think it is useful\n• And explain how you felt about it\n\n描述一本你读过的有用的书',
                    sampleAnswer: `I'd like to talk about "Atomic Habits" by James Clear, a self-improvement book I read about a year ago. A friend recommended it when I was struggling with procrastination and wanted to develop better study habits.
...
5. "resonate with someone" – The author's message about persistence really resonated with me.
   （作者关于坚持的信息真的与我产生了共鸣。）`,
            ...
            },
            {
                id: 229,
                type: 'hot',
                topic: '别人帮助下做的决定 Important Decision',
                difficulty: 'Medium',
                difficultyColor: 'bg-pink-100 text-pink-700',
                part2: {
                    question: 'Describe an important decision made with the help of other people\nYou should say:\n• What the decision was\n• Why you made the decision\n• Who helped you make the decision\n• And how you felt about it\n\n描述一个在别人帮助下做出的重要决定',
                    sampleAnswer: `I'd like to talk about my decision to choose my university major, which I made with significant help from my parents, teachers, and a career counselor. This happened during my final year of high school.
...
5. "make an informed decision" – Research helps us make an informed decision.
   （研究帮助我们做出明智的决定。）`,
            ...
            },
            {
                id: 230,
                type: 'regular',
                topic: '等待特别事情 Waited for Something Special',
                difficulty: 'Medium',
                difficultyColor: 'bg-cyan-100 text-cyan-700',
                part2: {
                    question: 'Describe a time when you waited for something special that would happen\nYou should say:\n• What you waited for\n• Where you waited\n• Why it was special\n• And explain how you felt while you were waiting\n\n描述一次你等待特别事情发生的经历',
                    sampleAnswer: `I'd like to talk about waiting for my university admission results two years ago. This was one of the most nerve-wracking waits of my life.\n\n我想谈谈两年前等待大学录取结果的经历。这是我一生中最令人紧张的等待之一。
...
【常用表达】1. "nerve-wracking wait" 2. "mixture of emotions" 3. "make success sweeter"`,
            ...
            },
            {
                ...
                topic: '自然之地 Natural Place',
                difficulty: 'Easy',
                difficultyColor: 'bg-emerald-100 text-emerald-700',
                part2: {
                    question: 'Describe a natural place (e.g. parks, mountains)\nYou should say:\n• Where this place is\n• How you knew this place\n• What it is like\n• And explain why you like to visit it\n\n描述一个自然之地（如公园、山脉）',
                    sampleAnswer: `I'd like to talk about West Lake in Hangzhou, a beautiful natural place I visit regularly. It's located in the heart of Hangzhou city in Zhejiang Province, about an hour by train from where I live.
...
// Update user action buttons in navigation
    ...
    if (isAuthenticated && currentUser) {
        ...
        userActions.innerHTML = `
            <div class="relative group">
                <button class="flex items-center gap-2 px-5 py-2 rounded-xl font-medium text-sm transition-all bg-white text-primary-700 hover:bg-primary-50 shadow-sm">
                ...
                <div class="absolute right-0 mt-2 w-48 bg-white rounded-xl shadow-lg py-2 z-50 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                    <button onclick="router('profile')" class="block w-full text-left px-4 py-2 text-sm text-slate-700 hover:bg-primary-50 hover:text-primary-700 transition-colors">
                        ${t('nav.profile')}
                    </button>
                    ${currentUser.role === 'admin' ? `
                        <button onclick="router('admin')" class="block w-full text-left px-4 py-2 text-sm text-slate-700 hover:bg-primary-50 hover:text-primary-700 transition-colors">
                            ${t('nav.admin')}
                        </button>
                    ` : ''}
                    <button onclick="router('payment')" class="block w-full text-left px-4 py-2 text-sm text-slate-700 hover:bg-primary-50 hover:text-primary-700 transition-colors">
                        ${t('payment.title')}
                    </button>
                    <div class="border-t border-slate-200 my-1"></div>
                    <button onclick="logout()" class="block w-full text-left px-4 py-2 text-sm text-slate-700 hover:bg-red-50 hover:text-red-600 transition-colors">
                        ${t('nav.logout')}
                    </button>
                </div>
            </div>
    ...
    mainContent.innerHTML = `
        <div class="container mx-auto max-w-7xl">
            <div class="text-center mb-12">
                <h1 class="text-3xl font-bold text-slate-900 mb-2">${t('admin.title')}</h1>
                <p class="text-slate-600">${t('admin.subtitle')}</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                <div class="glass-card rounded-3xl p-8 shadow-lg">
                    <div class="text-center">
                        <h2 class="text-4xl font-bold text-primary-600 mb-2">${totalUsers}</h2>
                        <p class="text-slate-600">${t('admin.totalUsers')}</p>
                    </div>
                </div>
                <div class="glass-card rounded-3xl p-8 shadow-lg">
                    <div class="text-center">
                        <h2 class="text-4xl font-bold text-accent-600 mb-2">${activeSubscriptions}</h2>
                        <p class="text-slate-600">${t('admin.activeSubscriptions')}</p>
                    </div>
                </div>
            </div>
            
            <!-- User Management Section -->
            <div class="glass-card rounded-3xl p-8 shadow-lg mb-12">
                <div class="flex justify-between items-center mb-6">
                    <h2 class="text-2xl font-bold text-slate-900">${t('admin.users')}</h2>
                    <button onclick="exportUsers()" 
                            class="px-4 py-2 rounded-xl font-medium text-sm transition-all bg-primary-600 text-white hover:bg-primary-700 shadow-sm">
                        Export Users
                    </button>
                </div>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full min-w-full divide-y divide-slate-200">
                        <thead class="bg-slate-50">
                            <tr>
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-slate-500 uppercase tracking-wider">${t('admin.name')}</th>
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-slate-500 uppercase tracking-wider">${t('admin.email')}</th>
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-slate-500 uppercase tracking-wider">${t('admin.role')}</th>
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-slate-500 uppercase tracking-wider">${t('admin.subscription')}</th>
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-slate-500 uppercase tracking-wider">${t('admin.expiry')}</th>
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-slate-500 uppercase tracking-wider">${t('admin.status')}</th>
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-slate-500 uppercase tracking-wider">${t('admin.actions')}</th>
                            </tr>
                        </thead>
        ...
        return `
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-slate-900">${subscriptionPlans[user.subscription].name[currentLang]}</div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-slate-500">${user.expiry}</div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
...
function editUser(userId) {
    // Mock edit function - in real app, this would open an edit modal
    const user = mockUsers.find(u => u.id === userId);
    if (user) {
        alert(`Edit user: ${user.name}`);
        // In a real app, you would open a modal with edit form here
    }
}

function deleteUser(userId) {
    // Mock delete function - in real app, this would show a confirmation dialog
        ...
        <div class="container mx-auto max-w-md">
            <div class="glass-card rounded-3xl p-8 shadow-xl">
                <div class="text-center mb-8">
                    <h1 class="text-3xl font-bold text-slate-900 mb-2">${t('login.title')}</h1>
                    <p class="text-slate-600">${t('login.subtitle')}</p>
                </div>
                
                <form onsubmit="event.preventDefault(); login();" class="space-y-6">
                    <div>
                        <label for="login-email" class="block text-sm font-medium text-slate-700 mb-2">${t('login.email')}</label>
                    ...
                    <div>
                        <div class="flex justify-between items-center mb-2">
                            <label for="login-password" class="block text-sm font-medium text-slate-700">${t('login.password')}</label>
                            <a href="#" class="text-sm text-primary-600 hover:text-primary-800 transition-colors">${t('login.forgotPassword')}</a>
                        </div>
                ...
                <div class="mt-6 text-center">
                    <p class="text-slate-600">
                        ...
                        <a href="#" onclick="router('register')" class="text-primary-600 font-bold hover:text-primary-800 transition-colors">${t('nav.register')}</a>
                    </p>
                </div>
            </div>
        </div>
...
function renderRegister() {
    mainContent.innerHTML = `
        <div class="container mx-auto max-w-md">
            <div class="glass-card rounded-3xl p-8 shadow-xl">
                <div class="text-center mb-8">
                    <h1 class="text-3xl font-bold text-slate-900 mb-2">${t('register.title')}</h1>
                    <p class="text-slate-600">${t('register.subtitle')}</p>
                </div>
                
                <form onsubmit="event.preventDefault(); register();" class="space-y-6">
                    <div>
                        <label for="register-name" class="block text-sm font-medium text-slate-700 mb-2">${t('register.name')}</label>
                    ...
                    <div>
                        <label for="register-email" class="block text-sm font-medium text-slate-700 mb-2">${t('register.email')}</label>
                    ...
                    <div>
                        <label for="register-password" class="block text-sm font-medium text-slate-700 mb-2">${t('register.password')}</label>
                        <input type="password" id="register-password" 
                               class="w-full px-4 py-3 rounded-xl border border-slate-300 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all bg-white/80 backdrop-blur-sm"
                               placeholder="${t('register.password')}" required>
                    </div>
                    
                    <div>
                        <label for="register-confirm" class="block text-sm font-medium text-slate-700 mb-2">${t('register.confirmPassword')}</label>
                        <input type="password" id="register-confirm" 
                               class="w-full px-4 py-3 rounded-xl border border-slate-300 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all bg-white/80 backdrop-blur-sm"
                               placeholder="${t('register.confirmPassword')}" required>
                    </div>
                ...
                <div class="mt-6 text-center">
                    <p class="text-slate-600">
                        ...
                        <a href="#" onclick="router('login')" class="text-primary-600 font-bold hover:text-primary-800 transition-colors">${t('nav.login')}</a>
                    </p>
                </div>
            </div>
        </div>
...
function renderProfile() {
    ...
    mainContent.innerHTML = `
        <div class="container mx-auto max-w-2xl">
            <div class="glass-card rounded-3xl p-8 shadow-xl">
                <div class="text-center mb-8">
                    <h1 class="text-3xl font-bold text-slate-900 mb-2">${t('profile.title')}</h1>
                ...
                <div class="space-y-8">
                    ...
                    <div class="bg-white/80 rounded-2xl p-6 shadow-sm">
                        <h2 class="text-xl font-bold text-slate-900 mb-4">${t('nav.profile')}</h2>
                        <div class="space-y-4">
                            <div class="grid grid-cols-3 gap-4">
                                <span class="text-sm font-medium text-slate-600">${t('profile.name')}:</span>
                                <span class="col-span-2 text-slate-900">${currentUser.name}</span>
                            </div>
                            <div class="grid grid-cols-3 gap-4">
                                <span class="text-sm font-medium text-slate-600">${t('profile.email')}:</span>
                                <span class="col-span-2 text-slate-900">${currentUser.email}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white/80 rounded-2xl p-6 shadow-sm">
                        <div class="flex justify-between items-center mb-4">
                            <h2 class="text-xl font-bold text-slate-900">${t('profile.subscription')}</h2>
                            <button onclick="router('payment')" 
                                    class="px-4 py-2 rounded-xl font-medium text-sm transition-all bg-primary-600 text-white hover:bg-primary-700 shadow-sm">
                        ...
                        <div class="space-y-4">
                            <div class="grid grid-cols-3 gap-4">
                                <span class="text-sm font-medium text-slate-600">${t('profile.subscription')}:</span>
                                <span class="col-span-2 text-slate-900">${subscriptionPlans[currentUser.subscription].name[currentLang]}</span>
                            </div>
                            <div class="grid grid-cols-3 gap-4">
                                <span class="text-sm font-medium text-slate-600">${t('profile.status')}:</span>
                                <span class="col-span-2 text-green-600 font-medium">Active</span>
                            </div>
                            <div class="grid grid-cols-3 gap-4">
                                <span class="text-sm font-medium text-slate-600">${t('profile.expiry')}:</span>
                                <span class="col-span-2 text-slate-900">${currentUser.expiry}</span>
                            </div>
                        </div>
                        
                        <!-- Subscription Features -->
                        <div class="mt-6">
                            <h3 class="text-sm font-medium text-slate-600 mb-3">${t('payment.features')}:</h3>
                            <ul class="space-y-2">
                                ${subscriptionPlans[currentUser.subscription].features.map(feature => `
                    ...
                    <button onclick="logout()" 
                            class="w-full py-3 rounded-xl font-bold transition-all bg-white text-red-600 border border-red-200 hover:bg-red-50 hover:border-red-300 shadow-sm">
                        ${t('profile.logoutBtn')}
                    </button>
                </div>
            </div>
...
function renderPayment() {
    mainContent.innerHTML = `
        <div class="container mx-auto max-w-4xl">
            <div class="text-center mb-12">
                <h1 class="text-3xl font-bold text-slate-900 mb-2">${t('payment.title')}</h1>
                <p class="text-slate-600">${t('payment.subtitle')}</p>
            </div>
            
            <div class="grid md:grid-cols-2 gap-8">
                ${Object.entries(subscriptionPlans).map(([planKey, plan]) => `
                    <div class="glass-card rounded-3xl p-8 shadow-lg transition-all hover:shadow-xl ${planKey === 'premium' ? 'border-2 border-primary-500 scale-105' : 'border border-slate-200'}">
                        <div class="text-center mb-6">
                            <h2 class="text-2xl font-bold text-slate-900 mb-2">${plan.name[currentLang]}</h2>
                            <p class="text-slate-600 mb-4">${planKey === 'basic' ? t('payment.basicDesc') : t('payment.premiumDesc')}</p>
                            
                            <div class="mb-4">
                                <span class="text-4xl font-bold text-primary-600">${t('payment.price')}${plan.price.monthly}</span>
                                <span class="text-slate-500">/${t('payment.monthly')}</span>
                            </div>
                            <div class="text-sm text-slate-500">
                                <span class="line-through">${t('payment.price')}${plan.price.yearly / 12}</span> ${t('payment.yearly')} ${t('payment.price')}${plan.price.yearly}
                            </div>
                        </div>
                            ...
                            <ul class="space-y-3">
                                ${plan.features.map(feature => `
                                    <li class="flex items-start gap-2">
                                        ...
                                        <span class="text-slate-700">${feature[currentLang]}</span>
                                    </li>
                                `).join('')}
                            </ul>
                        </div>
                        
                        <button onclick="processPayment('${planKey}')" 
                                class="w-full py-3 rounded-xl font-bold text-sm transition-all ${planKey === 'premium' ? 'bg-primary-600 text-white hover:bg-primary-700 shadow-lg' : 'bg-white text-primary-700 hover:bg-primary-50 border border-primary-200'}">
                            ${t('payment.subscribeBtn')}
                        </button>
                    </div>
                `).join('')}
            </div>
        ...
        <div class="container mx-auto max-w-6xl">
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center mb-24">
                <div class="space-y-8 text-center lg:text-left">
                    <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/50 border border-white/60 backdrop-blur-sm shadow-sm">
                        ...
                        <span class="text-sm font-medium text-slate-600">${t('home.badge')}</span>
                    </div>
                    <h1 class="text-5xl lg:text-7xl font-bold text-slate-900 tracking-tight leading-tight">
                        ${t('home.title1')} <br />
                        <span class="text-transparent bg-clip-text bg-gradient-to-r from-primary-600 to-accent-500">${t('home.title2')}</span>
                    </h1>
                    <p class="text-xl text-slate-600 leading-relaxed max-w-xl mx-auto lg:mx-0">
                        ${t('home.subtitle')}
                    </p>
                    <div class="flex gap-4 justify-center lg:justify-start">
                        <button onclick="router('topics')" class="bg-primary-600 text-white px-8 py-4 rounded-xl font-bold hover:bg-primary-700 transition shadow-lg shadow-primary-500/30">${t('home.btnStart')}</button>
                        <button onclick="router('practice')" class="bg-white text-primary-700 px-8 py-4 rounded-xl font-bold border border-primary-100 hover:bg-primary-50 transition">${t('home.btnPractice')}</button>
                    </div>
                </div>
                <div class="relative grid grid-cols-2 gap-4 max-w-md mx-auto lg:mx-0">
                    ...
                    <div class="glass-card p-6 rounded-2xl hover:scale-105 transition-all duration-300 border border-white/60 shadow-xl bg-gradient-to-br from-white/80 to-blue-50/80 backdrop-blur-md group">
                        ...
                        <div class="flex items-center justify-between mb-4 relative">
                            ...
                            <span class="text-[10px] font-bold px-2 py-1 rounded-full bg-blue-50 text-blue-600 border border-blue-100">${currentLang === 'zh' ? '结构' : 'Structure'}</span>
                        </div>
                        <div class="font-bold text-slate-900 text-lg mb-1 relative">${t('home.card1Title')}</div>
                        <div class="text-sm text-slate-500 leading-relaxed relative">${t('home.card1Desc')}</div>
                    </div>
                    ...
                    <div class="glass-card p-6 rounded-2xl hover:scale-105 transition-all duration-300 border border-white/60 shadow-xl bg-gradient-to-br from-white/80 to-purple-50/80 backdrop-blur-md group">
                        ...
                        <div class="flex items-center justify-between mb-4 relative">
                            ...
                            <span class="text-[10px] font-bold px-2 py-1 rounded-full bg-purple-50 text-purple-600 border border-purple-100">${currentLang === 'zh' ? '词汇' : 'Lexical'}</span>
                        </div>
                        <div class="font-bold text-slate-900 text-lg mb-1 relative">${t('home.card2Title')}</div>
                        <div class="text-sm text-slate-500 leading-relaxed relative">${t('home.card2Desc')}</div>
                    </div>
            ...
            <div class="grid md:grid-cols-3 gap-6">
                <div class="glass-card p-8 rounded-3xl relative overflow-hidden group cursor-pointer" onclick="router('topics')">
                    ...
                    <h3 class="text-2xl font-bold mb-2">${t('home.feature1Title')}</h3>
                    <p class="text-slate-600 mb-4">${t('home.feature1Desc')}</p>
                    <span class="text-primary-600 font-semibold group-hover:translate-x-2 transition-transform inline-block">${currentLang === 'zh' ? '浏览' : 'Browse'} &rarr;</span>
                </div>
                <div class="glass-card p-8 rounded-3xl bg-slate-900 text-white cursor-pointer" onclick="router('tips')">
                    <h3 class="text-2xl font-bold mb-2">${t('home.feature2Title')}</h3>
                    <p class="text-slate-400 mb-4">${t('home.feature2Desc')}</p>
                    <span class="text-accent-400 font-semibold">${currentLang === 'zh' ? '查看' : 'View'} &rarr;</span>
                </div>
                <div class="glass-card p-8 rounded-3xl cursor-pointer group" onclick="router('practice')">
                    <h3 class="text-2xl font-bold mb-2">${t('home.feature3Title')}</h3>
                    <p class="text-slate-600 mb-4">${t('home.feature3Desc')}</p>
                    <span class="text-primary-600 font-semibold group-hover:translate-x-2 transition-transform inline-block">${currentLang === 'zh' ? '开始' : 'Start'} &rarr;</span>
                </div>
            </div>
        </div>
    `;
    ...
    let content = `
        <div class="container mx-auto max-w-7xl">
            ...
            <div class="text-center mb-10">
                <h2 class="text-4xl font-bold text-slate-900 mb-3">${t('topics.title')}</h2>
                <p class="text-lg text-slate-600">${t('topics.subtitle')}</p>
            </div>
            ...
            <div class="flex justify-center gap-3 mb-12">
                ${['part1', 'part2', 'part3'].map(p => `
                    <button onclick="switchTopicPart('${p}')" id="btn-${p}" 
                        class="px-8 py-4 rounded-2xl font-bold transition-all text-sm uppercase tracking-wider shadow-md hover:shadow-lg ${p === 'part1' ? 'bg-gradient-to-r from-primary-600 to-primary-700 text-white scale-105' : 'bg-white text-slate-700 hover:bg-slate-50'}">
                        ${p.replace('part', 'Part ')}
                    </button>
                `).join('')}
            </div>
...
function switchTopicPart(part) {
    ...
    ['part1', 'part2', 'part3'].forEach(p => {
        ...
        if (p === part) {
            btn.className = 'px-8 py-4 rounded-2xl font-bold transition-all text-sm uppercase tracking-wider shadow-md hover:shadow-lg bg-gradient-to-r from-primary-600 to-primary-700 text-white scale-105';
        } else {
            btn.className = 'px-8 py-4 rounded-2xl font-bold transition-all text-sm uppercase tracking-wider shadow-md hover:shadow-lg bg-white text-slate-700 hover:bg-slate-50';
        }
    });
    ...
    container.innerHTML = data.map(cat => `
        <div class="glass-card rounded-3xl overflow-hidden shadow-lg border border-white/50">
            ...
            <div class="p-6 bg-white/60">
                <div class="grid ${part === 'part1' || part === 'part3' ? 'md:grid-cols-2 lg:grid-cols-3' : 'md:grid-cols-2'} gap-5">
                    ${cat.topics.map(t => `
                        <div class="bg-white rounded-2xl p-6 shadow-sm hover:shadow-md transition-all border border-slate-100 hover:border-primary-200">
                            ...
                            ${t.cueCard ?
            `<div class="text-sm text-slate-700 leading-relaxed whitespace-pre-line bg-slate-50/80 p-4 rounded-xl border border-slate-100">${t.cueCard}</div>` :
            `<ul class="space-y-3">
                                    ${t.questions.map(q => `
...
function renderPractice() {
    ...
    // Filter topics based on current tab
    const filteredPart1 = db.practice.part1.filter(t => t.type === currentPracticeTab);
    const filteredPart23 = db.practice.part23.filter(t => t.type === currentPracticeTab);

    mainContent.innerHTML = `
        <div class="container mx-auto max-w-7xl">
            <!-- Header -->
            <div class="text-center mb-8">
                <h1 class="text-3xl font-bold text-slate-900 mb-2">${t('practice.title')}</h1>
                <p class="text-slate-600 mb-6">${t('practice.subtitle')}</p>
                
                <!-- Tab Switcher -->
                <div class="inline-flex bg-slate-100 p-1 rounded-xl">
                    <button onclick="switchPracticeTab('regular')" class="px-6 py-2 rounded-lg text-sm font-bold transition-all ${currentPracticeTab === 'regular' ? 'bg-white text-primary-600 shadow-sm' : 'text-slate-500 hover:text-slate-700'}">
                        ${t('practice.regularTopics')}
                    </button>
                    <button onclick="switchPracticeTab('hot')" class="px-6 py-2 rounded-lg text-sm font-bold transition-all ${currentPracticeTab === 'hot' ? 'bg-white text-primary-600 shadow-sm' : 'text-slate-500 hover:text-slate-700'}">
                        ${t('practice.hotTopics')}
                    </button>
                </div>
            </div>
            ...
            <div class="mb-10">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <div>
                        <h2 class="text-xl font-bold text-slate-900">${t('practice.part1Title')}</h2>
                        <p class="text-sm text-slate-500">${t('practice.part1Desc')}</p>
                    </div>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                    ${filteredPart1.length ? filteredPart1.map(t => renderCard(t, 'part1')).join('') : '<div class="col-span-full text-slate-400 text-center py-8 italic">暂无相关Part 1练习题</div>'}
                </div>
            </div>
            ...
            <div class="mb-10">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <div>
                        <h2 class="text-xl font-bold text-slate-900">${t('practice.part23Title')}</h2>
                        <p class="text-sm text-slate-500">${t('practice.part23Desc')}</p>
                    </div>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ${filteredPart23.length ? filteredPart23.map(t => renderCard(t, 'part23')).join('') : '<div class="col-span-full text-slate-400 text-center py-8 italic">暂无相关Part 2/3练习题</div>'}
                </div>
            </div>
        </div>
    `;
...
function parseSampleAnswer(text) {
    if (!text) return { main: '', framework: [], vocab: [], phrases: [] };

    // Normalize text
    text = text.replace(/\r\n/g, '\n');

    const sections = {
        framework: '【答题框架 Answer Framework】',
        vocab: '【核心词汇 Key Vocabulary】',
        phrases: '【常用表达 Useful Phrases & Examples】'
    };
    ...
    // Extract in reverse order of appearance in text
    phrases = extract(sections.phrases);
    vocab = extract(sections.vocab);
    framework = extract(sections.framework);

    return { main: main.trim(), framework, vocab, phrases };
}
...
function renderPracticeDetail() {
    ...
    const renderAnalysis = (parsed) => `
        <!-- Analysis Grid -->
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            <!-- Framework -->
            ${parsed.framework.length ? `
            <div class="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow">
                <h3 class="text-xs font-bold text-slate-400 uppercase tracking-wider mb-4 flex items-center gap-2">
                    <span class="text-lg">🏗️</span> ${currentLang === 'zh' ? '答题框架 Framework' : 'Answer Framework'}
                </h3>
                <div class="space-y-3">
                    ${parsed.framework.map(step => `
                        <div class="flex items-start gap-3">
                            ...
                            <p class="text-sm text-slate-700 leading-relaxed pt-0.5">${step.replace(/^\d+\.\s*/, '')}</p>
                        </div>
                    `).join('')}
                </div>
            </div>` : ''}
            ...
            <div class="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow">
                <h3 class="text-xs font-bold text-slate-400 uppercase tracking-wider mb-4 flex items-center gap-2">
                    <span class="text-lg">📚</span> ${currentLang === 'zh' ? '核心词汇 Vocabulary' : 'Key Vocabulary'}
                </h3>
                <div class="grid gap-3">
                    ${parsed.vocab.map(v => {
        const cleanV = v.replace(/^[•·-]\s*/, '');
        const parts = cleanV.split(/[:：]/);
        const word = parts[0];
        const def = parts.slice(1).join(':');
        return `
                        <div class="group p-2 rounded-lg hover:bg-slate-50 transition-colors">
                            <div class="font-bold text-slate-800 text-sm mb-0.5 text-primary-700">${word}</div>
                            ${def ? `<div class="text-xs text-slate-500 leading-relaxed">${def}</div>` : ''}
                        </div>
                        `;
    }).join('')}
                </div>
        ...
        <div class="bg-gradient-to-br from-orange-50 to-amber-50/50 p-6 rounded-2xl border border-orange-100/50 mb-8">
            <h3 class="text-xs font-bold text-orange-800/70 uppercase tracking-wider mb-4 flex items-center gap-2">
                <span class="text-lg">💬</span> ${currentLang === 'zh' ? '常用表达 Useful Phrases' : 'Useful Phrases'}
            </h3>
    ...
    if (type === 'part1') {
        const parsed = parseSampleAnswer(t.sampleAnswer);

        // Render Part 1 Detail Page
        mainContent.innerHTML = `
            <div class="container mx-auto max-w-5xl">
                ...
                <button onclick="router('practice')" class="mb-8 flex items-center gap-2 text-slate-600 hover:text-primary-600 transition font-semibold group">
                    ...
                    <span>${currentLang === 'zh' ? '返回练习中心' : 'Back to Practice Center'}</span>
                </button>
                ...
                <div class="bg-white rounded-3xl shadow-xl border border-slate-200 overflow-hidden">
                    ...
                    <div class="bg-gradient-to-r from-primary-50 to-accent-50 px-10 py-8 border-b border-slate-200">
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <span class="px-4 py-1.5 rounded-full ${t.difficultyColor} text-xs font-bold uppercase">${currentLang === 'zh' ? (t.difficulty === 'Easy' ? '简单' : t.difficulty === 'Medium' ? '中等' : '困难') : t.difficulty}</span>
                        </div>
                        <h1 class="text-4xl font-bold text-slate-900 mb-2">${t.topic}</h1>
                    </div>
                    
                    <!-- Question Section -->
                    <div class="px-10 py-8 bg-slate-50/50 border-b border-slate-200">
                        <h3 class="text-xs font-bold text-slate-400 uppercase tracking-wider mb-4">📝 ${currentLang === 'zh' ? 'Question 问题' : 'Question'}</h3>
                        <div class="bg-white p-6 rounded-2xl border-2 border-primary-100 shadow-sm">
                            <p class="text-xl font-medium text-slate-800 leading-relaxed whitespace-pre-line">${t.question}</p>
                        </div>
                    </div>
                    ...
                    <div class="px-10 py-8">
                        <button onclick="toggleAnswer(this)" class="mb-6 px-6 py-3 bg-primary-50 hover:bg-primary-100 text-primary-700 rounded-xl text-sm font-bold transition-colors flex items-center gap-2">
                            <span>👁️</span> ${currentLang === 'zh' ? '查看参考答案 Show Answer' : 'Show Answer'}
                        </button>
                            ...
                            <div class="prose prose-lg max-w-none">
                                ...
                                <div class="mb-10">
                                    <h3 class="text-sm font-bold text-slate-400 uppercase tracking-wider mb-4 flex items-center gap-2">
                                        <span class="text-lg">💡</span> ${currentLang === 'zh' ? '参考答案 Sample Answer' : 'Sample Answer'}
                                    </h3>
                                    <div class="text-base text-slate-700 leading-loose whitespace-pre-line pl-4 border-l-4 border-primary-200">${parsed.main}</div>
                                </div>
                                ...
                                <div class="bg-slate-50 p-8 rounded-2xl border border-slate-200">
                                    <h4 class="text-sm font-bold text-slate-500 uppercase tracking-wider mb-4 flex items-center gap-2">
                                        <span class="text-lg">✨</span> ${currentLang === 'zh' ? '专家点评 Expert Tips' : 'Expert Tips'}
                                    </h4>
                                    <ul class="space-y-3">
                                        ${t.tips.map(tip => `<li class="flex items-start text-sm text-slate-600"><span class="mr-3 text-primary-500 font-bold">✓</span><span class="leading-relaxed">${tip}</span></li>`).join('')}
                                    </ul>
                                </div>
                            </div>
                        </div>
        ...
        const parsed = parseSampleAnswer(t.part2.sampleAnswer);

        // Render Part 2 & 3 Detail Page
        mainContent.innerHTML = `
            <div class="container mx-auto max-w-6xl">
                <!-- Back Button -->
                <button onclick="router('practice')" class="mb-8 flex items-center gap-2 text-slate-600 hover:text-primary-600 transition font-semibold group">
                ...
                <div class="bg-white rounded-3xl shadow-xl border border-slate-200 overflow-hidden mb-8">
                    ...
                    <div class="bg-gradient-to-r from-accent-50 to-primary-50 px-10 py-8 border-b border-slate-200">
                        ...
                        <h1 class="text-4xl font-bold text-slate-900">${t.topic}</h1>
                    </div>
                    
                    <!-- Question Section -->
                    <div class="px-10 py-8 bg-slate-50/50 border-b border-slate-200">
                        <h3 class="text-xs font-bold text-slate-400 uppercase tracking-wider mb-4">📝 ${currentLang === 'zh' ? 'Cue Card 话题卡' : 'Cue Card'}</h3>
                        <div class="bg-white p-8 rounded-2xl border-2 border-accent-200 shadow-sm relative overflow-hidden">
                            ...
                            <p class="text-lg font-medium text-slate-800 leading-relaxed whitespace-pre-line relative z-10">${t.part2.question}</p>
                        </div>
                    </div>
                        ...
                        <div class="hidden transform transition-all duration-300 origin-top">
                            <div class="prose prose-lg max-w-none">
                                ...
                                <div class="mb-10">
                                    ...
                                    <div class="text-base text-slate-700 leading-loose whitespace-pre-line pl-4 border-l-4 border-accent-200">${parsed.main}</div>
                                </div>
                                ...
                                <div class="bg-slate-50 p-8 rounded-2xl border border-slate-200">
                                    ...
                                    <ul class="space-y-3">
                                        ${t.part2.tips.map(tip => `<li class="flex items-start text-sm text-slate-600"><span class="mr-3 text-accent-500 font-bold">✓</span><span class="leading-relaxed">${tip}</span></li>`).join('')}
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <div class="bg-white rounded-3xl shadow-xl border border-slate-200 overflow-hidden">
                    ...
                    <div class="bg-gradient-to-r from-purple-50 to-pink-50 px-10 py-8 border-b border-slate-200">
                        ...
                        <h2 class="text-3xl font-bold text-slate-900">${currentLang === 'zh' ? 'Follow-up Discussion 深入讨论' : 'Follow-up Discussion'}</h2>
                    </div>
            ...
            const parsed = parseSampleAnswer(qa.a);
            return `
                                <div class="relative pl-8 group">
                                    ...
                                    <h4 class="font-bold text-slate-900 mb-4 text-lg flex items-start gap-2">
                                        <span class="text-purple-500 font-black text-xl opacity-50">0${idx + 1}</span>
                                        <span class="pt-0.5">${qa.q}</span>
                                    </h4>
                                    ...
                                    <button onclick="toggleAnswer(this)" class="mb-4 px-5 py-2 bg-purple-50 hover:bg-purple-100 text-purple-700 rounded-lg text-sm font-bold transition-colors flex items-center gap-2">
                                        <span>👁️</span> ${currentLang === 'zh' ? '查看范例答案 Show Answer' : 'Show Answer'}
                                    </button>
                                    ...
                                    <div class="hidden transform transition-all duration-300 origin-top">
                                        ...
                                        <div class="text-base text-slate-700 bg-slate-50 p-6 rounded-2xl border border-slate-100 leading-relaxed relative mb-6">
                                            ...
                                            <span class="text-xs font-bold text-purple-600 uppercase tracking-wider block mb-3 flex items-center gap-2">
                                                <span class="text-lg">💬</span> ${currentLang === 'zh' ? '范例答案 Model Answer' : 'Model Answer'}
                                            </span>
                                            <div class="whitespace-pre-line">${parsed.main}</div>
                                        </div>
                                        
                                        <!-- Analysis Sections -->
                                        ${parsed.framework.length || parsed.vocab.length || parsed.phrases.length ? `
                                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4">
                                            ...
                                            <div class="bg-white p-5 rounded-xl border border-purple-100 shadow-sm">
                                                <h5 class="text-xs font-bold text-purple-400 uppercase tracking-wider mb-3 flex items-center gap-2">
                                                    <span class="text-base">🎯</span> ${currentLang === 'zh' ? '答题思路 Framework' : 'Answer Framework'}
                                                </h5>
                                                <div class="space-y-2">
                                                    ${parsed.framework.map(step => `
                                                        <div class="flex items-start gap-2">
                                                            ...
                                                            <p class="text-xs text-slate-600 leading-relaxed">${step.replace(/^\d+\.?\s*/, '')}</p>
                                                        </div>
                                                    `).join('')}
                                                </div>
                                            </div>` : ''}
                                            ...
                                            <div class="bg-white p-5 rounded-xl border border-purple-100 shadow-sm">
                                                <h5 class="text-xs font-bold text-purple-400 uppercase tracking-wider mb-3 flex items-center gap-2">
                                                    <span class="text-base">📖</span> ${currentLang === 'zh' ? '核心词汇 Vocabulary' : 'Key Vocabulary'}
                                                </h5>
                ...
                return `
                                                        <div class="p-2 rounded-lg hover:bg-purple-50/50 transition-colors">
                                                            <div class="font-bold text-purple-700 text-xs mb-0.5">${word}</div>
